<section class="content-header">
    ...
    <section class="content">
            <form name="withdrawal_form" action="export-pharmacy_network.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id='users_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=pharmacy_networks" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" 
                                    data-sort-order="desc" data-show-export="true" data-export-types='["txt","csv"]' 
                                    data-export-options='{
                                        "fileName": "pharmacy_networks-list-<?= date('d-m-Y') ?>",
