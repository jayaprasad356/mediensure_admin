<section class="content-header">
    ...
    <section class="content">
            <form name="withdrawal_form" action="export-radiology_network.php" method="post" enctype="multipart/form-data">
